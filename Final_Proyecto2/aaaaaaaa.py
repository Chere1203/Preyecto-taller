...
class TextWindow(QWidget):
    def __init__(self):
        super().__init__()
        self.setWindowTitle('Cargar y Leer Archivos de Texto')
        self.layout = QVBoxLayout()
...
class MainWindow(QMainWindow):
    ...
    def create_menu(self):
        ...
        load_action = archivo_menu.addAction('Cargar Archivo de Texto')
        load_action.triggered.connect(self.show_text_window)
...
class AudioWindow(QWidget):
    def __init__(self):
        ...
        self.text_window_button = QPushButton('Abrir ventana de texto')
        self.layout.addWidget(self.text_window_button)
        ...
        self.text_window_button.clicked.connect(self.open_text_window)
    ...
    def open_text_window(self):
        ...
        self.setCentralWidget(self.audio_window)
    ...
    def create_menu(self):
        ...
        audio_action = archivo_menu.addAction('Abrir ventana de audio')
        audio_action.triggered.connect(self.show_audio_window)
